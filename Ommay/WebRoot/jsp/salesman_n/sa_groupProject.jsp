...
<body>
	...
	<section class="container">
		<div class="row">
			...
			<!-- 右侧主要内容 -->
			<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10" id="showBox" data-box="sa_groupProject">
								...
								<table class="table table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td><a class="linkBtn" href="<%=path%>/project/workerGetSingleProjectById?id=${project.uidProject}" data-url="sa_projectDetail">${project.clientName}</a></td>
