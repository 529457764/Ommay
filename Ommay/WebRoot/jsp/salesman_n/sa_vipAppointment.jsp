			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-navbar-collapse">
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span><%=request.getAttribute("vipAccountName")%></span>业务员<b class="caret"></b></a>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
				...
				<ul class="list-group">
					...
					<a href="<%=path%>/salesman/sa_vipAppointment" data-url="sa_vipAppointment" class="list-group-item active">个人体检预约</a>
			...
			<!-- 右侧主要内容 -->
			<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10" id="showBox" data-box="sa_vipAppointment">
