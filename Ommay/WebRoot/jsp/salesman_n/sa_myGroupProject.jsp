				...
				<div class="collapse navbar-collapse" id="bs-navbar-collapse">
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown"><span><%=id%></span>业务员<b class="caret"></b></a>
...
<%--
				<ul class="list-group">
					...
					<a href="<%=path%>/salesman/sa_groupAppointment"
						data-url="sa_groupAppointment" class="list-group-item">团体体检预约</a>
					<a href="<%=path%>/salesman/sa_vipAppointment"
						data-url="sa_vipAppointment" class="list-group-item">个人体检预约</a>
					<a href="<%=path%>/view/sa_userCenter" data-url="sa_userCenter"
			...
			<!-- 右侧主要内容 -->
			<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10" id="showBox" data-box="sa_myGroupProject">
							...
							<div class="row col-md-12">
								<form class="form" action="#">
									<div class="form-group fl">
										<a href="<%=path%>/view/sa_newProject"><button type="button" class="btn btn-sm btn-primary">新建项目</button></a>
									</div>
									...
									<tbody>
										<c:forEach items="${list}" var="project" varStatus="status">
											<tr>
												...
												<td><a class="linkBtn" href="<%=path%>/project/workerGetSingleProjectById?id=${project.uidProject}" data-url="sa_projectDetail">${project.clientName}</a></td><td>${project.peopleNumber}</td>
