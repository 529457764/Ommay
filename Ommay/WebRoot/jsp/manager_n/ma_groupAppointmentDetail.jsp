...
<body>
	...
	<section class="container">
		<div class="row">
			...
			<!-- 右侧主要内容 -->
			<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10" id="showBox"  data-box="ma_groupAppointmentDetail">
				<div class="row col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="row col-md-12 fr tr">
								<a href="#"><button type="button" class="btn btn-default btn-sm">确定预约</button></a>
								<a href="#"><button type="button" class="btn btn-default btn-sm">返回</button></a>
							</div>
						</div>
					</div>
				</div>
