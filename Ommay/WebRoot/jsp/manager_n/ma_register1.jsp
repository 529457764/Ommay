...
<body>
	...
	<section class="container">
		<div class="row">
			...
			<!-- 右侧主要内容 -->
			<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10" id="showBox" data-box="ma_register1">
				<div class="col-md-12 row">
					<div class="row">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">注册业务员</h3>
							</div>
							<div class="panel-body">
								<form:form commandName="accountForm" action="../account/checkRegister" class="row col-md-6">
									...
									<input type="hidden" name="accountFlag" value="6">
									<div class="form-group">
