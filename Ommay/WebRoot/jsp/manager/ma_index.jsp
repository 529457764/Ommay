	...
	<section class="container">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
				<ul class="list-group">
					<a href="javascript:void(0);" data-url="ma_groupProject" class="list-group-item">团体项目</a>
					<a href="javascript:void(0);" data-url="ma_myGroupProject" class="list-group-item">我的团体项目</a>
					<a href="javascript:void(0);" data-url="ma_vipProject" class="list-group-item">会员项目</a>
					<a href="javascript:void(0);" data-url="ma_myVipProject" class="list-group-item">我的会员项目</a>
					<a href="javascript:void(0);" data-url="ma_groupAppointment" class="list-group-item">团体体检预约</a>
					<a href="javascript:void(0);" data-url="ma_salesmanManage" class="list-group-item">业务员管理</a>
					<a href="javascript:void(0);" data-url="ma_userCenter" class="list-group-item">用户中心</a>
				</ul>
			</div>
			<!-- 右侧主要内容 -->
